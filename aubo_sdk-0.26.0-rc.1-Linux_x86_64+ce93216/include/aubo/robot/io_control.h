...
public:
     ...
     *
     * @return Number of tool digital IOs (including digital inputs and outputs).
     *
     * @throws arcs::common_interface::AuboException
     *
     * @par Python function prototype
     ...
     *
     * @note
     * When the input is set to no trigger action (StandardInputAction::Default),
     * setting the digital input value to high will not trigger any robot action.\n
     * When a trigger action is set, setting the digital input value to high will trigger the corresponding robot action.\n
     * For example, if DI0 is set to trigger Handguide (StandardInputAction::Handguide),
     * setting DI0 to high will enable hand-guiding mode.
     * Setting DI0 to low will exit hand-guiding mode.
     *
     * @param index: Indicates the IO pin, starting from 0.
     * For example, 0 means the first pin.
     ...
     * @note
     * When the input is set to no trigger action (StandardInputAction::Default),
     * setting the tool digital input value to high will not trigger any robot action.\n
     * When a trigger action is set, setting the tool digital input value to high will trigger the corresponding robot action.\n
     * For example, if TOOL_IO[0] is set as input and its trigger action is Handguide (StandardInputAction::Handguide),
     ...
     * @throws arcs::common_interface::AuboException
     *
     * @note This function takes effect only when the safety input action of the configurable input is set to SafetyInputAction::Unassigned.
     *
     * @par Python function prototype
     * setConfigurableDigitalInputAction(self: pyaubo_sdk.IoControl, arg0: int,
     * arg1: arcs::common_interface::StandardInputAction) -> int
     ...
     * For example, when DO0's output runstate is set to indicate hand-guiding (StandardOutputRunState::Handguiding),
     * the robot enters hand-guiding mode and DO0 will automatically become high.
     * When the robot exits hand-guiding, DO0 will automatically become low.
     *
     * @return Returns 0 on success; error code on failure.
     * AUBO_BUSY
     * AUBO_BAD_STATE
     ...
     * users can set the digital output value.\n
     * When the output runstate is set, users cannot set the digital output value, and the controller will set it automatically.\n
     * For example, when TOOL_IO[0] is set as output and its runstate is set to indicate hand-guiding (StandardOutputRunState::Handguiding),
     * the robot enters hand-guiding mode and TOOL_IO[0] will automatically become high.
     * When the robot exits hand-guiding, TOOL_IO[0] will automatically become low.
     *
     * @param index: Indicates the IO pin, starting from 0.
     * For example, 0 means the first pin.
     * @param runstate: Output runstate selection
     ...
     * For example, when AO0's output runstate is set to indicate hand-guiding (StandardOutputRunState::Handguiding),
     * the robot enters hand-guiding mode and AO0 will automatically become the maximum value.
     * When the robot exits hand-guiding, AO0 will automatically become 0.
     *
     * @param index: Indicates the IO pin, starting from 0.
     * For example, 0 means the first pin.
     * @param runstate: Output runstate selection
     ...
     * For example, if the return value is 2863267846, its binary representation is 10101010101010100000000000000110.
     * The lower 16 bits represent the status of all standard digital inputs,
     * the least significant bit indicates the input status of DI00, the second least significant bit indicates DI01, and so on.\n
     ...
     * For example, if the return value is 2863267846, its binary representation is 10101010101010100000000000000110.
     * The lower 16 bits represent the status of all input pins,
     * the least significant bit indicates the input status of pin 0, the second least significant bit indicates pin 1, and so on.\n
     * 1 means high level, 0 means low level.
     *
     * @throws arcs::common_interface::AuboException
     *
     ...
     * For example, if the return value is 2863267846, its binary representation is 10101010101010100000000000000110.
     * The lower 16 bits represent the status of all standard digital outputs,
     * the least significant bit indicates the output status of DO00, the second least significant bit indicates DO01, and so on.\n
     * 1 means high level, 0 means low level.
     *
     * @throws arcs::common_interface::AuboException
     *
     ...
     * For example, if the return value is 2863267846, its binary representation is 10101010101010100000000000000110.
     * The lower 16 bits represent the status of all output pins,
     * the least significant bit indicates the output status of pin 0, the second least significant bit indicates pin 1, and so on.\n
     * 1 means high level, 0 means low level.
     *
     * @throws arcs::common_interface::AuboException
     *
     ...
     * For example, if the return value is 2863267846, its binary representation is 10101010101010100000000000000110.
     * The lower 16 bits represent the status of all static link inputs,
     * the least significant bit indicates the input status of pin 0, the second least significant bit indicates pin 1, and so on.\n
     * 1 means high level, 0 means low level.
     *
     * @throws arcs::common_interface::AuboException
     ...
     * For example, if the return value is 2863267846, its binary representation is 10101010101010100000000000000110.
     * The lower 16 bits represent the status of all static link outputs,
     * the least significant bit indicates the output status of pin 0, the second least significant bit indicates pin 1, and so on.\n
     * 1 means high level, 0 means low level.
     *
     * @throws arcs::common_interface::AuboException
     ...
     *
     * @return Returns true if the robot is equipped with an encoder, otherwise false.
     *
     * @throws arcs::common_interface::AuboException
     *
     * @par JSON-RPC request example
